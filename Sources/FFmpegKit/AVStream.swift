...
public enum AVDiscard: Int32 {
    ...
    var native: Libffmpeg.AVDiscard {
        Libffmpeg.AVDiscard(rawValue)
    }

    init(native: Libffmpeg.AVDiscard) {
...
typealias CAVStream = Libffmpeg.AVStream
...
public extension AVStream {
    ...
    /// - Throws: AVError
    func addSideData(type: AVPacketSideDataType, data: UnsafeMutablePointer<UInt8>, size: Int) throws {
    ...
    func newSideData(type: AVPacketSideDataType, size: Int) -> UnsafeMutablePointer<UInt8> {
    ...
    func getSideData(type: AVPacketSideDataType, size: UnsafeMutablePointer<Int>) -> UnsafeMutablePointer<UInt8> {
