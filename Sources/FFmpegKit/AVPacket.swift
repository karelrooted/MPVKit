...
typealias CAVPacket = Libffmpeg.AVPacket
...
public enum AVPacketSideDataType: UInt32 {
  ...
  var native: Libffmpeg.AVPacketSideDataType {
    Libffmpeg.AVPacketSideDataType(rawValue)
  }

  init(native: Libffmpeg.AVPacketSideDataType) {
