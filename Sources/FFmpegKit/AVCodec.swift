...
public typealias AVCodecID = Libffmpeg.AVCodecID

public extension AVCodecID {
    static let none = AV_CODEC_ID_NONE

    // MARK: - Video Codecs

    static let MPEG1VIDEO = AV_CODEC_ID_MPEG1VIDEO
    /// preferred ID for MPEG-1/2 video decoding
    static let MPEG2VIDEO = AV_CODEC_ID_MPEG2VIDEO
    static let H261 = AV_CODEC_ID_H261
    static let H263 = AV_CODEC_ID_H263
    static let MPEG4 = AV_CODEC_ID_MPEG4
    static let H264 = AV_CODEC_ID_H264
    static let VP3 = AV_CODEC_ID_VP3
    static let PNG = AV_CODEC_ID_PNG
    static let PGM = AV_CODEC_ID_PGM
    static let BMP = AV_CODEC_ID_BMP
    static let JPEG2000 = AV_CODEC_ID_JPEG2000
    static let VP5 = AV_CODEC_ID_VP5
    static let VP6 = AV_CODEC_ID_VP6
    static let TIFF = AV_CODEC_ID_TIFF
    static let GIF = AV_CODEC_ID_GIF
    static let VP8 = AV_CODEC_ID_VP8
    static let VP9 = AV_CODEC_ID_VP9
    static let WEBP = AV_CODEC_ID_WEBP
    static let HEVC = AV_CODEC_ID_HEVC
    static let VP7 = AV_CODEC_ID_VP7
    static let APNG = AV_CODEC_ID_APNG
    static let AV1 = AV_CODEC_ID_AV1
    static let SVG = AV_CODEC_ID_SVG

    // MARK: - various PCM "codecs"

    /// A dummy id pointing at the start of audio codecs
    static let FIRST_AUDIO = AV_CODEC_ID_FIRST_AUDIO
    static let PCM_S16LE = AV_CODEC_ID_PCM_S16LE
    static let PCM_S16BE = AV_CODEC_ID_PCM_S16BE
    static let PCM_U16LE = AV_CODEC_ID_PCM_U16LE
    static let PCM_U16BE = AV_CODEC_ID_PCM_U16BE
    static let PCM_S8 = AV_CODEC_ID_PCM_S8
    static let PCM_U8 = AV_CODEC_ID_PCM_U8
    static let PCM_MULAW = AV_CODEC_ID_PCM_MULAW
    static let PCM_ALAW = AV_CODEC_ID_PCM_ALAW
    static let PCM_S32LE = AV_CODEC_ID_PCM_S32LE
    static let PCM_S32BE = AV_CODEC_ID_PCM_S32BE
    static let PCM_U32LE = AV_CODEC_ID_PCM_U32LE
    static let PCM_U32BE = AV_CODEC_ID_PCM_U32BE
    static let PCM_S24LE = AV_CODEC_ID_PCM_S24LE
    static let PCM_S24BE = AV_CODEC_ID_PCM_S24BE
    static let PCM_U24LE = AV_CODEC_ID_PCM_U24LE
    static let PCM_U24BE = AV_CODEC_ID_PCM_U24BE
    static let PCM_S24DAUD = AV_CODEC_ID_PCM_S24DAUD
    static let PCM_ZORK = AV_CODEC_ID_PCM_ZORK
    static let PCM_S16LE_PLANAR = AV_CODEC_ID_PCM_S16LE_PLANAR
    static let PCM_DVD = AV_CODEC_ID_PCM_DVD
    static let PCM_F32BE = AV_CODEC_ID_PCM_F32BE
    static let PCM_F32LE = AV_CODEC_ID_PCM_F32LE
    static let PCM_F64BE = AV_CODEC_ID_PCM_F64BE
    static let PCM_F64LE = AV_CODEC_ID_PCM_F64LE
    static let PCM_BLURAY = AV_CODEC_ID_PCM_BLURAY
    static let PCM_LXF = AV_CODEC_ID_PCM_LXF
    static let S302M = AV_CODEC_ID_S302M
    static let PCM_S8_PLANAR = AV_CODEC_ID_PCM_S8_PLANAR
    static let PCM_S24LE_PLANAR = AV_CODEC_ID_PCM_S24LE_PLANAR
    static let PCM_S32LE_PLANAR = AV_CODEC_ID_PCM_S32LE_PLANAR
    static let PCM_S16BE_PLANAR = AV_CODEC_ID_PCM_S16BE_PLANAR

    static let PCM_S64LE = AV_CODEC_ID_PCM_S64LE
    static let PCM_S64BE = AV_CODEC_ID_PCM_S64BE
    static let PCM_F16LE = AV_CODEC_ID_PCM_F16LE
    static let PCM_F24LE = AV_CODEC_ID_PCM_F24LE

    // MARK: - AMR

    static let AMR_NB = AV_CODEC_ID_AMR_NB
    static let AMR_WB = AV_CODEC_ID_AMR_WB

    // MARK: - Audio Codecs

    static let MP2 = AV_CODEC_ID_MP2
    /// preferred ID for decoding MPEG audio layer 1, 2 or 3
    static let MP3 = AV_CODEC_ID_MP3
    static let AAC = AV_CODEC_ID_AAC
    static let FLAC = AV_CODEC_ID_FLAC
    static let APE = AV_CODEC_ID_APE
    static let MP1 = AV_CODEC_ID_MP1

    // MARK: - Subtitle Codecs

    static let HDMV_PGS_SUBTITLE = AV_CODEC_ID_HDMV_PGS_SUBTITLE
    static let DVD_SUBTITLE = AV_CODEC_ID_DVD_SUBTITLE
...
typealias CAVCodec = Libffmpeg.AVCodec
...
public struct AVCodec {
    ...
    public var supportedChannelLayouts: [AVChannelLayout]? {
        values(native.pointee.ch_layouts, until: AVChannelLayout())
    }
