...
public enum AVPictureType: UInt32 {
  ...
  var native: Libffmpeg.AVPictureType {
    Libffmpeg.AVPictureType(rawValue)
  }

  init(native: Libffmpeg.AVPictureType) {
...
public typealias AVComponentDescriptor = Libffmpeg.AVComponentDescriptor
...
public struct AVPixelFormatDescriptor {
  ...
  public var componentDescriptors: [FFmpegKit.AVComponentDescriptor] {
...
public typealias AVFieldOrder = Libffmpeg.AVFieldOrder

extension Libffmpeg.AVFieldOrder {
