...
public enum AVHWDeviceType: UInt32 {
  ...
  var native: Libffmpeg.AVHWDeviceType {
    Libffmpeg.AVHWDeviceType(rawValue)
  }

  init(native: Libffmpeg.AVHWDeviceType) {
...
typealias CAVCodecHWConfig = Libffmpeg.AVCodecHWConfig
...
public enum AVHWFrameTransferDirection: UInt32 {
  ...
  var native: Libffmpeg.AVHWFrameTransferDirection {
    Libffmpeg.AVHWFrameTransferDirection(rawValue)
  }

  init(native: Libffmpeg.AVHWFrameTransferDirection) {
...
typealias CAVHWFramesContext = Libffmpeg.AVHWFramesContext
