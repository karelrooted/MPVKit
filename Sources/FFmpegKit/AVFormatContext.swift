...
typealias CAVFormatContext = Libffmpeg.AVFormatContext
...
public struct AVDurationEstimationMethod: Equatable {
    ...
    public let rawValue: Libffmpeg.AVDurationEstimationMethod
    public init(rawValue: Libffmpeg.AVDurationEstimationMethod) { self.rawValue = rawValue }
}
