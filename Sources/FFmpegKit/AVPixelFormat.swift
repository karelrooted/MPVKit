...
public typealias AVPixelFormat = Libffmpeg.AVPixelFormat
...
public enum AVColorPrimaries: UInt32 {
  ...
  var native: Libffmpeg.AVColorPrimaries {
    Libffmpeg.AVColorPrimaries(rawValue)
  }

  init(native: Libffmpeg.AVColorPrimaries) {
...
public enum AVColorTransferCharacteristic: UInt32 {
  ...
  var native: Libffmpeg.AVColorTransferCharacteristic {
    Libffmpeg.AVColorTransferCharacteristic(rawValue)
  }

  init(native: Libffmpeg.AVColorTransferCharacteristic) {
...
public enum AVColorSpace: UInt32 {
  ...
  var native: Libffmpeg.AVColorSpace {
    Libffmpeg.AVColorSpace(rawValue)
  }

  init(native: Libffmpeg.AVColorSpace) {
...
public enum AVColorRange: UInt32 {
  ...
  var native: Libffmpeg.AVColorRange {
    Libffmpeg.AVColorRange(rawValue)
  }

  init(native: Libffmpeg.AVColorRange) {
...
public enum AVChromaLocation: UInt32 {
  ...
  var native: Libffmpeg.AVChromaLocation {
    Libffmpeg.AVChromaLocation(rawValue)
  }

  init(native: Libffmpeg.AVChromaLocation) {
